...
def _decimal_env(name, default):
    """Read a Decimal from env with a safe fallback."""
...
FREE_DELIVERY_THRESHOLD = _decimal_env('FREE_DELIVERY_THRESHOLD', '30')
STANDARD_DELIVERY_PERCENTAGE = _decimal_env('STANDARD_DELIVERY_PERCENTAGE', '10')